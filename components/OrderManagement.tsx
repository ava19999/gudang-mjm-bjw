        ...
        {activeTab === 'ONLINE' && (
          <div className="space-y-3">
            ...
            {filterList(onlineData).map((item, idx) => (
              <div key={`${item.tanggal}-${item.resi}-${item.part_number || 'no-part'}-${idx}`} className="bg-gray-800 border border-gray-700 p-4 rounded-xl flex flex-col md:flex-row justify-between gap-4">
                <div>
